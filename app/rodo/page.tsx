...
export const metadata: Metadata = {
  title: 'Informacje RODO | KsięgaI',
  description: 'Informacje RODO – klauzula informacyjna dotycząca przetwarzania danych osobowych przez Tovernet sp. z o.o.',
};
  ...
  return (
    <div className="prose prose-lg dark:prose-invert max-w-none">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p>Twoje dane mogą być przetwarzane w sposób zautomatyzowany, w tym w formie profilowania, w następujących celach:</p>
          <ul className="list-disc pl-6 space-y-2">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p>Podanie danych osobowych jest:</p>
          <ul className="list-disc pl-6 space-y-2">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p>Aby skorzystać z przysługujących Ci praw, skontaktuj się z nami:</p>
          <ul className="list-disc pl-6 space-y-2">
