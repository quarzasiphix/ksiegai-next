...
export const metadata: Metadata = {
  title: 'Polityka zwrotów | KsięgaI',
  description: 'Polityka zwrotów i odstąpienia od umowy – KsięgaI, Tovernet sp. z o.o.',
};
    ...
    <div className="prose prose-lg dark:prose-invert max-w-none">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <p>W oświadczeniu należy podać:</p>
          <ul className="list-disc pl-6 space-y-2">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p>Możesz anulować swoją subskrypcję w każdym momencie w ustawieniach konta.</p>
          <p><strong>Anulowanie jest skuteczne z końcem bieżącego okresu rozliczeniowego.</strong> Oznacza to, że:</p>
          <ul className="list-disc pl-6 space-y-2">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p>Rozważymy zwrot środków w następujących przypadkach:</p>
          <ul className="list-disc pl-6 space-y-2">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p>Nie dokonujemy zwrotów w następujących przypadkach:</p>
          <ul className="list-disc pl-6 space-y-2">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p>Jeśli masz jakiekolwiek problemy z naszymi usługami, skontaktuj się z nami:</p>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <p>W reklamacji prosimy o podanie:</p>
          <ul className="list-disc pl-6 space-y-2">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          <p>Konsument ma prawo do skorzystania z pozasądowych sposobów rozpatrywania reklamacji i dochodzenia roszczeń.</p>
          <p>
...
export default function RefundPolicy() {
  return (
    <LegalDocumentPage
      ...
      fallbackTitle="Polityka zwrotów"
