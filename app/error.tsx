  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-xl dark:bg-gray-800">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Wystąpił błąd aplikacji</h1>
        <p className="mt-3 text-sm text-gray-600 dark:text-gray-300">
          Spróbuj odświeżyć widok. Jeśli problem wraca, uruchom ponownie aplikację.
        </p>
        <button
          onClick={reset}
